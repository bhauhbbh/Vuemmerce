<template>
  <nav
    class="flex justify-between sticky top-0 bg-indigo z-10 px-3 py-5"
    role="navigation"
    ...
    <div class="flex items-center">
      <div class="mx-2">
        <div class="cursor-pointer" @click="showCheckoutModal">
          <span
            style="height: 50px; width: 50px; font-size: 17px;"
            :class="[
              numProductsAdded > 0 ? 'p-2 bg-white text-indigo rounded-3xl' : ''
            ]"
